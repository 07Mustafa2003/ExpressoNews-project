    ...
    return (
        <div className="flex justify-between gap-4">
            <div className="flex flex-col items-center">
                <HeadingTitle title="Sport" />
                <img src="assets/sportwin.jpg" alt="US Politics" className="w-full rounded-lg shadow-lg mb-4" />
            ...
            <div className="flex flex-col items-center">
                <HeadingTitle title="Style" />
                <img src="assets/style.jpg" alt="Science and Health" className="w-full rounded-lg shadow-lg mb-4" />
                <h2 className="text-xl font-semibold">Related Links</h2>
                <div className="w-full border rounded-lg p-2">
                    <ul>
            ...
            <div className="flex flex-col items-center">
                <HeadingTitle title="Opinion" />
                <img src="assets/opinion.jpg" alt="Tech" className="w-full rounded-lg shadow-lg mb-4" />
                <h2 className="text-xl font-semibold">Related Links</h2>
                <div className="w-full border rounded-lg p-2">
                    <ul>
